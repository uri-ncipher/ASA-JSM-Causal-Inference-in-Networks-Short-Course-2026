...
source("gcomp_dr_v2.R") #removed warnings for bootstrap
```
...
- $\alpha_0 = 0.75$ versus $\alpha_1 = 0.25$;

- $\alpha_0 = 0.75$ versus $\alpha_1 = 0.50$;

- $\alpha_0 = 0.25$ versus $\alpha_1 = 0.50$.
...
Now, we provide example code for an outcome-model based approach, g-computation. We use assumptions similar to IPW2 regarding the exposure and covariates for confounding from an individual's contacts in the network. We obtain 95% confidence intervals using a bootstrap on each individual and the summary information for their contacts' exposures and covariates.
